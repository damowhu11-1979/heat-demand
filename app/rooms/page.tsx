        ...
        <div style={modalBackdrop} onClick={() => setShowModal(false)}>
          <div style={modal} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={grid2}>
              <div>
                ...
                <Select
                  value={form.zone}
                  onChange={(e) =>
                    setForm({ ...form, zone: Number((e.target as HTMLSelectElement).value) })
                  }
                >
                  {zones.map((z, i) => (
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                <Input
                  ...
                  onChange={(e) =>
                    setForm({
                      ...form,
                      maxCeiling: Number((e.target as HTMLInputElement).value || 0),
                    })
                  }
                  style={{ maxWidth: 160 }}
                />
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setForm({
                      ...form,
                      intermittentPct: val === '' ? undefined : Number(val),
                    });
                  }}
                  style={{ maxWidth: 160 }}
                />
              ...
              <p style={hint}>
                Adds a percentage allowance for heat-up on top of fabric loss.
              </p>
            </div>
              ...
              <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setForm({
                      ...form,
                      heatGainsW: val === '' ? undefined : Number(val),
                    });
                  }}
                  style={{ maxWidth: 160 }}
                />
